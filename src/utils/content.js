...
export const about = `
  ...
  <p>
  I build things for the web with a background in design — I studied and worked as a Designer for about 6 years and now enjoy building accessible, lean and maintainable Front-end stacks, and have been doing it for the past ${experienceYears} years or so.
  </p>
  <p>
    When I’m not making stuff for the web, I enjoy building and flying drones, tinkering with 3D printing and electronics projects, four-wheel driving, <a href="https://www.instagram.com/qkevinto/">photography</a>, exploring the outdoors and travelling!
  </p>
  <p>

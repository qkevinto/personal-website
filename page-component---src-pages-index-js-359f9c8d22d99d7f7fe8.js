...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _truncateString = __webpack_require__("./src/utils/truncate-string.js");
	
	var _truncateString2 = _interopRequireDefault(_truncateString);
	    ...
	    value: function componentDidMount() {
	      ...
	      fetch('https://api.github.com/users/' + this.state.username + '/events').then(function (response) {
	        ...
	        _this2.setState({
	          ...
	          link: '' + _this2.props.appURL + latestEvent.repo.name,
	  ...
	  _createClass(Instagram, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      fetch('https://pacific-caverns-68032.herokuapp.com/instagram').then(function (response) {
	        ...
	        var latestPost = response.items[0];
	
	        _this2.setState({
	          loading: false,
	          content: (0, _truncateString2.default)(latestPost.caption.text, 250),
	          background: latestPost.images.standard_resolution.url,
	          link: latestPost.link,
	          metaPrimary: (0, _distance_in_words_to_now2.default)(new Date(latestPost.caption.created_time * 1000).toString(), { addSuffix: true }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MainModule = __webpack_require__("./src/components/Main.module.scss");
	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: _MainModule2.default.root },
...
/***/ "./node_modules/css-loader/index.js?modules&minimize&importLoaders=1!./node_modules/sass-loader/index.js!./src/components/Main.module.scss":
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._3pbErbp8dADOkh55OmhIs6{display:flex;flex-direction:column;min-height:100%}@media (min-width:60rem){._3pbErbp8dADOkh55OmhIs6{flex-direction:row}}", ""]);
	
	// exports
	exports.locals = {
		"root": "_3pbErbp8dADOkh55OmhIs6"
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__("./node_modules/css-loader/index.js?modules&minimize&importLoaders=1!./node_modules/sass-loader/index.js!./src/components/Main.module.scss");
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__("./node_modules/style-loader/addStyles.js")(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js?modules&minimize&importLoaders=1!../../node_modules/sass-loader/index.js!./Main.module.scss", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js?modules&minimize&importLoaders=1!../../node_modules/sass-loader/index.js!./Main.module.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	  ...
	  _createClass(SocialActivities, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { className: _SocialActivitiesModule2.default.list, 'aria-label': 'Recent social activities' },
	          _react2.default.createElement(
	            'li',
...
/***/ (function(module, exports) {
	...
	var role = exports.role = 'Lead Front-end Developer';
	var work = exports.work = 'Okendo, Sydney';
	...
	var siteMetadata = exports.siteMetadata = {
...
//# sourceMappingURL=page-component---src-pages-index-js-359f9c8d22d99d7f7fe8.js.map